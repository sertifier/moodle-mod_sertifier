...
class backup_sertifier_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the sertifier.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_sertifier_activity_structure_step('sertifier_structure', 'sertifier.xml'));
    }
