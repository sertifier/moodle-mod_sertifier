...
$PAGE->set_url('/mod/sertifier/index.php', ['id' => $course->id]);
...
$table->head = [$strname, get_string('datecreated', 'sertifier')];

foreach ($certificates as $certificate) {
    $link = html_writer::tag(
        'a',
        $certificate->name,
        ['href' => $CFG->wwwroot . '/mod/sertifier/view.php?id=' . $certificate->coursemodule]
    );
